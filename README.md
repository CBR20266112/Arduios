...
이 프로젝트는 GitHub Pages에서 정적 웹앱으로 바로 실행되도록 구성되어 있습니다.

- 저장소의 main 브랜치를 기준으로 배포
- 루트에 index.html 유지
- 상대 경로 사용으로 GitHub Pages 프로젝트 URL에서 정상 로딩
- 별도 로컬 서버 없이 브라우저에서 바로 실행 가능

배포 후 접속 주소 예시:

https://<사용자이름>.github.io/Arduios/
